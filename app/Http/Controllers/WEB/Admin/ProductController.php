...
//  dd('last');
    ...
    public function edit($id)
    {
        ...
        return view('admin.edit_product',compact('sizes','categories','brands','specificationKeys','product','subCategories','childCategories','productSpecifications'));
