...
class SettingController extends Controller
{
    ...
    public function index(){
        ...
        return view('admin.setting',compact('setting','cookieConsent','googleRecaptcha','facebookComment','tawkChat','googleAnalytic','customPaginations','socialLogin','facebookPixel','currencies','pusher','sitePixel'));
    }
