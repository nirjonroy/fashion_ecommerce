...
class CartController extends Controller
{
    ...
    {     
        ...
        if (!empty($request->variation)) {
            // Retrieve the variation price from the database
            $variation = ProductVariant::find($request->variation);

            if ($variation) {
                $selectedVariationPrice = $variation->sell_price;
                // dd($selectedVariationPrice);
            }
        }
