        ...
        <tr>
          <td>
              <div class="d-flex justify-content-between align-item-conter al_btn">
                              <p class="login_text" style="font-size: 14px;">অ্যাকাউন্ট থাকলে লগিন করুন  <a style="font-size: 11px;" class="btn btn-success" href="{{url('login-user')}}" class="text-muted text-decoration-none icon-signin">Login</a></p>
                            
               </div>
            </td>
          <td>
               <div id="coupon-toggle" style="font-size: 12px;" class="btn btn-primary">কুপন কোড থাকলে এপ্লাই করুন</div>
  ...
  <div class="card-body">  
                        ...
                        <form action="{{ route('front.checkout.store') }}" method="POST" id="checkoutForm">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-12 mb-3 form-floating">
                                      ...
                                      <label for="name" class="ps-4">আপনার নাম লিখুন</label>
                                </div>
                        ...
                        <input type="hidden" name="total_amount" id="total_amount" value="{{ number_format($sub_total, 2) }}">
                            ...
                            <!--</div>-->
                              ...
                              <!--</div>-->
                              <button type="submit" class="btn bg-blue text-light" style="font-family: 'Kalpurush', sans-serif;width: 100%;height: 50px;font-size: 20px;">অর্ডার কনফার্ম করুন <i class="fas fa-arrow-right"></i></button>
