 ...
 <header>
     ...
     <nav class="navbar navbar_justify_content_sm" style="background: linear-gradient(90deg, #002f6c, #00c8ff) !important;">
            <div class="container-fluid row justify-content-between align-items-center nav_section">
                ...
                <div class="col-3 d-block d-lg-none" style="padding-right: 0%;">
                   <a style="float: right;padding: 0px;" href="{{ route('front.checkout.index') }}" class="btn pmd-btn-fab pmd-ripple-effect fixed-cart-bottom12" type="button">  
