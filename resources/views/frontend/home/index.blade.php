...
<div class="bg-gradient container-fluid" style="background: linear-gradient(120deg, #b4ffcb -20%, #1C863C 100%) !important;">
    <div class="col-12 product-header">
        <div class="section_title text-light">
           <a href="{{url('shop', $products->first()->category->slug)}}" style="color: #218A41;"> <h4 class="semi p-1 m-0 prodCatcus" style="text-align:center">{{ $products->first()->category->name }}</h4> </a>
        </div>
    </div>
</div>
            ...
            <div class="product-item" style="">
                ...
                <div class="product_content " style="border-top:3px solid #EDEDEF; margin-top: 10% ">
                    ...
                    <div class="rounded-0 bg-muted p-2 d-flex justify-content-between">
                        ...
                        <a data-id="{{ $product->id }}" data-url="{{ route('front.cart.store') }}" style="background: red;color: white;font-size: 13px;border: solid;" class="btn btn-sm btn-warning semi add-to-cart">
                           {{ BanglaText('cart') }}
                        </a>
            ...
            <div class="product-item" style="">
               ...
               <div class="product_content" style="border-top:3px solid #EDEDEF; margin-top: 10%;">
                  ...
                  <div class="price_box ps-1 justify-content-center" style="padding-bottom: 6px;">
                     ...
                     <span class="current_price">৳{{$sale->product->price}}</span>
                     @else
                  ...
                  <div class="rounded-0 bg-muted p-2 d-flex justify-content-between">
                   <a data-id="{{ $product->id }}" data-url="{{ route('front.cart.store') }}" style="color: white;font-size: 13px;background: red;border: solid;" class="btn btn-sm btn-warning semi add-to-cart">
                       {{ BanglaText('cart') }}
                        </a>

                    <a href="{{ route('front.check.single', ['product_id' => $sale->product->id]) }}"
                       style="color: white; font-size: 12px;background: red;border: solid;"
                       class="btn btn-sm btn-warning semi buy-now"
                       data-url="{{ route('front.cart.store') }}">
                   {{ BanglaText('order') }}
                    </a>
