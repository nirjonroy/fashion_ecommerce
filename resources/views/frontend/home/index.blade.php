                        ...
                        <div class="col-lg-2 col-lg-feaCat col-md-2 col-sm-4  col-4 my-1 p-1">
                           ...
                           <div class="category text-center p-4 rounded-3">
                                @if(!empty($item->category->slug))
                                     ...
                                     <p class="pt-3 mb-0 font-14 bold">{{ $item->category->name }}</p>
                                @endif
                           </div>
                           </a>
                        </div>
...
<div class="bg-gradient container-fluid" style="background: linear-gradient(90deg, #002f6c, #00c8ff) !important;">
...
<div class="bg-gradient container-fluid" style="background: linear-gradient(90deg, #002f6c, #00c8ff) !important;">
    <div class="col-12 product-header">
        <div class="section_title text-light">
           ...
           <a href="{{url('shop', $products->first()->category->slug)}}" style="color: #218A41;"> <h4 class="p-1 m-0 prodCatcus" style="text-align:center"><span style="width: auto;">
