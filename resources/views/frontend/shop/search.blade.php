                    ...
                    <div class="product-box py-1 bg-muted row">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product-item">
                                <div class="product_thumb">
                                    <a class="primary_img" href="#"><img src="{{ asset('uploads/custom-images2/'.$product->thumb_image) }}" alt=""></a>
                                    <a class="secondary_img" href="#"><img src="{{ asset('uploads/custom-images2/'.$product->thumb_image) }}" alt=""></a>
                        ...
                        Add to cart
                                       ...
                                       <a href="{{ route('front.check.single', ['product_id' => $product->id]) }}"
                                           ...
                                           class="btn btn-sm btn-warning semi bg-orange buy-now"
