                                ...
                                <div class="col-md-4">
                                  ...
                                  <div class="form-group col-12">
                                    ...
                                    <select name="order_status" class="form-control select2" id="brand">
                                      ...
                                      <option {{ $order->order_status == 1 ? 'selected' : '' }} value="1">Progress Orders</option>
                                      <option {{ $order->order_status == 2 ? 'selected' : '' }} value="2">Delivered Orders</option>
                                      <option {{ $order->order_status == 3 ? 'selected' : '' }} value="3">Completed Orders</option>
                                      <option {{ $order->order_status == 4 ? 'selected' : '' }} value="4">Declined Orders</option>
                          ...
                          <div class="col-md-12">
                            <div class="row">
                              ...
                              <table class="table table-centered table-nowrap mb-0" id="product_table">
                                ...
                                <tfoot>
                                    <tr style="border-top: 2px solid black;">
                                        ...
                                        <td>
                                            <input type="text" class="form-control total_qty" id="total_qty" value="{{ $order->product_qty }}" disabled></td>
                              ...
                              <div class="form-group col-12">
                                    ...
                                    <input type="text" id="short_name" class="form-control"  name="short_name" value="{{ $order->orderAddress->shipping_phone }}">
                                </div>
                              </div>
