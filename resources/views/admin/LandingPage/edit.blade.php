    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="mb-3">
                ...
                <textarea class="form-control summernote" name="title2" value="{{$item->title2}}" rows="10" cols="10"></textarea>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="mb-3">
                ...
                <textarea class="form-control summernote" name="des1" value="{{$item->des1}}" rows="10" cols="10"></textarea>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="mb-3">
                ...
                <textarea class="form-control summernote" name="des3" value="{{$item->des3}}" rows="10" cols="10"></textarea>
            </div>
        </div>
        ...
        <div class="col-lg-12" id="product_search" style="display: none;">
                        ...
                        <div class="product_table" id="data">
                            <table class="table table-centered table-nowrap mb-0" id="product_table">
                                ...
                                <tbody id="data">
                                   <tr><td><img src="" height="50" width="50"/></td>
