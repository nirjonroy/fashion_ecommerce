                  ...
                  <div class="element-widget-wrap">
                     <div class="element-widget ord" style="margin-bottom: 25px;">
                        <h2 class="top-heading-title bg-light-green">
                           অর্ডার কত িচের র্ট সি ত্য দয়ে পরন রুন 
                        </h2>
                     </div>
                                 ...
                                 <div class="form-address">
                                    <div class="address-col">
                                       ...
                                       <div class="billing-fields">
                                          ...
                                          <input type="text" id="product_name" value="{{ $ln_pg->product->name }}" name="product_name">
                                          <div class="form-group">
                                             <label for="">আপা সমুর্ন িকনা <span>*</span></label>
                                 ...
                                 <div class="order-col" style="width: 100%;">
                                    ...
                                    <div id="order_review" class="review-order">
                                       ...
                                       <div id="payment" class="checkout-payment">
                                          ...
                                          <p style="color: green;">* ১০০% শির ে র্ডার কু,হতুক  অর্ করন না ।</p>
                                          <div class="form-row place-order">
                                             <button type="submit" class="button" name="" id=""> অর্ডর ু</button>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
