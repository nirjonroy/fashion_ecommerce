                        ...
                        <div class="row">
                            <div class="col-md-4">
                              ...
                              <div class="form-group col-12">
                                    ...
                                    <textarea name="shipping_address" id="" cols="10" rows="5" class="form-control text-area-5"></textarea>
                                </div>
                              </div>
